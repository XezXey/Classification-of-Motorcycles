	...
	int out_attributes)
{
	...
	bool input_file_load_status = read_data_from_file_predict(data_in_filename.c_str(), data, n_samples, in_attributes);
	bool output_file_load_status = read_data_from_file_predict(data_out_filename.c_str(), responses, n_samples, out_attributes);
