...
//This program take image as an input and calculate the HoG for each block then visualize it. And use for training ANNs
...
void export_hog_value_to_file(vector<float> hog_value_motorcycle_roi);
...
int main(int argc, char** argv)
{
	...
	export_hog_value_to_file(hog_value_motorcycle_roi);
...
void export_hog_value_to_file(vector<float> hog_value_motorcycle_roi) 
{
	...
	hog_value_file.open("hog_value_for_train.txt", ios::app);
